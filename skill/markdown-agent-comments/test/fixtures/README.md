...
- `demo.md` and `demo.processed.md` are a human-readable before/curated-reference pair.
...
Generated outputs such as `.generated/`, `runs/`, and `skill-evals/runs/` are ignored and must not be published.
