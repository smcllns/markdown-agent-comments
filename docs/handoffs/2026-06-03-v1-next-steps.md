...
1. Review the V1 human-review fixture and generated processed output:
   - `skill/markdown-agent-comments/test/human-review/README.md`
   - `skill/markdown-agent-comments/test/human-review/agent-input.md`
   - `skill/markdown-agent-comments/test/human-review/.generated/processed-output.md` after `bun run test:review`
